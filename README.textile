...
Preferences:
{:git=>true, :railsapps=>"none", :dev_webserver=>"thin", :prod_webserver=>"thin", :database=>"sqlite", :templates=>"erb", :unit_test=>"rspec", :integration=>"rspec-capybara", :fixtures=>"factory_girl", :frontend=>"foundation", :email=>"sendgrid", :authentication=>"omniauth", :omniauth_provider=>"twitter", :authorization=>"none", :form_builder=>"none", :starter_app=>"home_app", :quiet_assets=>true, :ban_spiders=>true}
